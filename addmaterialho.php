...
<div class="container-lg px-5">
    <!-- <h1> Inventory </h1> <hr>  -->
<h4> Add Materials </h4> <hr> 
<table>
<form class="addmaterial" action="connect1.php" method="POST">
<tr> <th> <label for="pname" style="font-size: 20px; padding-right: 10px;">Product Name</label> </th>
    <th> <input type="text" id="pname" name="pname" style="height: 25pt; width: max-content;"><br> </th> </tr>
...
<tr><td>.</td></tr>
    <tr> <th> </th>
        <th><input type="submit" value="Add" style="background-color:#1c7943; color: white;
            padding: 10px 20px;
            text-align: center; 
            text-decoration: none;
            display: inline-block;
            font-size: 20px;" name="submit"> </th> </tr>
</form>
</table>
</div>
...
<div class="data">
        ...
        <div class="card" style="width:100%; margin: 10px;">
            <h5 class="card-title" style="padding: 10px;">Products</h5>

        <?php
        include 'connection1.php';
        $sql = "SELECT pid, pname FROM `mfms`";
